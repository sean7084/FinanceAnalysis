...
_Generated: 2026-09-13T13:50:27Z_
...
| `DEFAULT_FROM_EMAIL` | `str` | `'noreply@financeanalysis.com'` | yes | base.py:347 |
...
| `EMAIL_BACKEND` | `str` | `'django.core.mail.backends.console.EmailBackend'` | yes | base.py:343 |
| `EMAIL_HOST` | `str` | `'localhost'` | yes | base.py:389 |
| `EMAIL_HOST_PASSWORD` | `str` | `''` | yes | base.py:393 |
| `EMAIL_HOST_USER` | `str` | `''` | yes | base.py:392 |
| `EMAIL_PORT` | `str` | `587` | yes | base.py:390 |
| `EMAIL_USE_TLS` | `bool` | `True` | yes | base.py:391 |
| `FRONTEND_URL` | `str` | `'http://localhost:5173'` | yes | base.py:401 |
...
| `SMS_WEBHOOK_URL` | `str` | `''` | yes | base.py:406 |
