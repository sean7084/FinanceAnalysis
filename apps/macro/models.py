...
class MacroSnapshot(models.Model):
    ...
    cn6m_yield = models.DecimalField(_('China 6M Yield'), max_digits=8, decimal_places=4, null=True, blank=True)
    cn1y_yield = models.DecimalField(_('China 1Y Yield'), max_digits=8, decimal_places=4, null=True, blank=True)
    cn3y_yield = models.DecimalField(_('China 3Y Yield'), max_digits=8, decimal_places=4, null=True, blank=True)
    cn5y_yield = models.DecimalField(_('China 5Y Yield'), max_digits=8, decimal_places=4, null=True, blank=True)
    cn7y_yield = models.DecimalField(_('China 7Y Yield'), max_digits=8, decimal_places=4, null=True, blank=True)
    cn10y_yield = models.DecimalField(_('China 10Y Yield'), max_digits=8, decimal_places=4, null=True, blank=True)
    cn30y_yield = models.DecimalField(_('China 30Y Yield'), max_digits=8, decimal_places=4, null=True, blank=True)
